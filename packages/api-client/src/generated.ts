...
export interface components {
    schemas: {
        ...
        BackendErrorResponse: {
            ...
            success: false;
            /** @enum {string} */
            code: "VALIDATION_ERROR" | "UNAUTHORIZED" | "FORBIDDEN" | "NOT_FOUND" | "CONFLICT" | "ALREADY_EXISTS" | "MISSING_IDEMPOTENCY_KEY" | "RATE_LIMITED" | "IDEMPOTENCY_KEY_REUSED_WITH_DIFFERENT_PAYLOAD" | "BACKEND_UNAVAILABLE" | "DEPENDENCY_UNAVAILABLE" | "INTERNAL_ERROR";
            message: string;
            status: number;
            requestId?: string;
