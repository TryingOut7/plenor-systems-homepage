...
// Called once daily by Vercel Cron (see vercel.json schedule: "0 8 * * *").
// Note: Vercel Hobby plan minimum interval is once per day. Upgrade to Pro for sub-hourly schedules.
