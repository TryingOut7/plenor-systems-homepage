...
function buildFallbackRuntimeConfig(): EmailRuntimeConfig {
  ...
  return {
    ...
    privacyPolicyUrl: resolveUrlLike(privacyFromEnv || '/privacy-policy', envSiteUrl),
...
async function loadRuntimeConfigFromCms(): Promise<Partial<EmailRuntimeConfig>> {
  ...
  return {
    ...
    privacyPolicyUrl: resolveUrlLike(readTrimmedString(routing?.privacyPolicyUrl) || '/privacy-policy', siteUrl),
