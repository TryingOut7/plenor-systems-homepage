...
// single connection slot. With max=1 the queue overflows the connectionTimeoutMillis
// on cold starts. 5 concurrent slots is safe against Supabase's Transaction Pooler
// (Supavisor) which can absorb unlimited app connections because it multiplexes them
// onto a smaller set of real PG connections.
